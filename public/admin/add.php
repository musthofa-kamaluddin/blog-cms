...
<body class="bg-gray-50 font-sans">
    ...
    <main class="container mx-auto px-4 py-12 max-w-2xl">
        <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Tambah Postingan</h2>
        <?php if (isset($error)): ?>
        ...
        <form method="POST" class="bg-white rounded-xl shadow-md p-8 space-y-6">
            <div>
                ...
                <input type="text" name="title" id="title" class="mt-1 w-full p-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" required>
            </div>
            <div>
                <label for="content" class="block text-sm font-medium text-gray-700">Konten</label>
                <textarea name="content" id="content" class="mt-1 w-full p-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" rows="10" required></textarea>
            </div>
